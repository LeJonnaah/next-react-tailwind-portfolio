    ...
    return (
        <>
            <div className="text-center shadow-lg p-10 rounded-xl my-10 ">
                ...
                <p className="py-2">Aesthetic and modern designs, paying attention to all the details.</p>
                <h4 className="py-4 text-pink-500 dark:text-pink-200">Design tools I use</h4>
                <ul className="text-gray-800 dark:text-slate-300">
                    <li className="py-1">Pain Tool Sai 2</li>
                    <li className="py-1">Canva</li>
            ...
            <div className="text-center shadow-lg p-10 rounded-xl my-10">
                ...
                <h4 className="py-4 text-pink-500 dark:text-pink-200">Programming languages I know</h4>
                <ul className="text-gray-800 dark:text-slate-300">
            ...
            <div className="text-center shadow-lg p-10 rounded-xl my-10">
                ...
                <h4 className="py-4 text-pink-500 dark:text-pink-200">Languages I know</h4>
                <ul className="text-gray-800 dark:text-slate-300">
